...
import { BlogXContractAddress } from '../context/address'
...
function BlogBox() {
    ...
    const addBlog = async () => {
        ...
        try {
            ...
            let addBlogTX = await blogXContract.addBlog(blog.blogText, blog.isDeleted);
            console.log("addBlogTX", addBlogTX);
